        ...
        signIn.apply {
            ...
            buttonSignIn.setOnClickListener {
                ...
                if (etEmail.text.toString().isNotEmpty() && etPassword.text.toString().isNotEmpty()) {
                    if (etEmail.text.toString() == shPref.getString("email", "").toString() && etPassword.text.toString() == shPref
                        ...
                        Toast.makeText(this@SignInActivity, R.string.invalid_input, Toast.LENGTH_SHORT).show()
                        Click(it)
                    }
                } else {
                    Toast.makeText(this@SignInActivity, R.string.empty_field, Toast.LENGTH_SHORT).show()
                }
            }
